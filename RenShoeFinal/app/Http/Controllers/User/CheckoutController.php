    ...
    public function store(Request $request)
{
    ...
    foreach ($carts as $cartItem) {
        foreach ($products as $product) {
            if ($cartItem["product_id"] == $product["id"]) {
                ...
                $mergedData[] = array_merge($cartItem, ["product_name" => $product["product_name"], 'price' => $product['price']]);
            }
        }
    }
    ...
    if ($newAddress['city'] != null) {
        ...
        $address->purok = $newAddress['purok'];
    ...
    if ($mainAddress) {
        ...
        $order->user_address_id = $mainAddress->id; // Set main address as order address
        $order->save();
        ...
        foreach ($cartItems as $cartItem) {
            ...
            // Deduct only quantity during checkout
            if ($product) {
